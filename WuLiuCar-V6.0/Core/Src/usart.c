...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC10     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = STANDBY_UART4_RX_Pin|STANDBY_UART4_TX_Pin;
  ...
  */
    ...
    PA15(JTDI)     ------> UART7_TX
    */
    GPIO_InitStruct.Pin = STANDBY_UART7_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF11_UART7;
    HAL_GPIO_Init(STANDBY_UART7_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = STANDBY_UART7_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF11_UART7;
    HAL_GPIO_Init(STANDBY_UART7_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB14     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = WHEEL_USART1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(WHEEL_USART1_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = WHEEL_USART1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART1;
    HAL_GPIO_Init(WHEEL_USART1_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = ARM_USART3_TX_Pin|ARM_USART3_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PC6     ------> USART6_TX
    */
    GPIO_InitStruct.Pin = BLE_USART6_RX_Pin|BLE_USART6_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PE2     ------> USART10_RX
    */
    GPIO_InitStruct.Pin = CAM_USART10_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF11_USART10;
    HAL_GPIO_Init(CAM_USART10_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CAM_USART10_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART10;
    HAL_GPIO_Init(CAM_USART10_RX_GPIO_Port, &GPIO_InitStruct);
    ...
    /* USART10_RX Init */
    hdma_usart10_rx.Instance = DMA2_Stream7;
    ...
    HAL_NVIC_SetPriority(USART10_IRQn, 4, 0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC10     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOC, STANDBY_UART4_RX_Pin|STANDBY_UART4_TX_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PA15(JTDI)     ------> UART7_TX
    */
    HAL_GPIO_DeInit(STANDBY_UART7_RX_GPIO_Port, STANDBY_UART7_RX_Pin);

    HAL_GPIO_DeInit(STANDBY_UART7_TX_GPIO_Port, STANDBY_UART7_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB14     ------> USART1_TX
    */
    HAL_GPIO_DeInit(WHEEL_USART1_RX_GPIO_Port, WHEEL_USART1_RX_Pin);

    HAL_GPIO_DeInit(WHEEL_USART1_TX_GPIO_Port, WHEEL_USART1_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, ARM_USART3_TX_Pin|ARM_USART3_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC6     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOC, BLE_USART6_RX_Pin|BLE_USART6_TX_Pin);
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PE2     ------> USART10_RX
    */
    HAL_GPIO_DeInit(GPIOE, CAM_USART10_TX_Pin|CAM_USART10_RX_Pin);
