...
void Arm_Absolute_Angle_To_0(uint8_t Address)
{
    ...
    Motor_Absolute_Control(Address, Arm_Velocity, Arm_Accelerate, Angle_0);
}
...
bool Arm_Coord_Control(Point3f_ *Point, Angle3f_ *Angle)
{
    ...
    if(Arm_Angle_Calculate(Point, Angle) == true)
    {
        ...
        Motor_Absolute_Control(Arm_Rear_Address, Arm_Velocity * k_a, Arm_Accelerate, Angle->a);
        Motor_Absolute_Control(Arm_Front_Address, Arm_Velocity * k_b, Arm_Accelerate, Angle->b);
        Motor_Absolute_Control(Arm_Pedestal_Address, Arm_Velocity * k_c, Arm_Accelerate, Angle->c);
        sign = true;
    }
