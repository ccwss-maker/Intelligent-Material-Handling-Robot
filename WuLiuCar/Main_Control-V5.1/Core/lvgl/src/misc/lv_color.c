 ...
 *      MACROS
 **********************/
//lv_color_t LV_COLOR_WHITE  = lv_color_make(0xFF, 0xFF, 0xFF);
//lv_color_t LV_COLOR_SILVER = lv_color_make(0xC0, 0xC0, 0xC0);
//lv_color_t LV_COLOR_GRAY   = lv_color_make(0x80, 0x80, 0x80);
//lv_color_t LV_COLOR_BLACK  = lv_color_make(0x00, 0x00, 0x00);
//lv_color_t LV_COLOR_RED     =lv_color_make(0xFF, 0x00, 0x00);
//lv_color_t LV_COLOR_MAROON = lv_color_make(0x80, 0x00, 0x00);
//lv_color_t LV_COLOR_YELLOW  =lv_color_make(0xFF, 0xFF, 0x00);
//lv_color_t LV_COLOR_OLIVE   =lv_color_make(0x80, 0x80, 0x00);
//lv_color_t LV_COLOR_LIME   = lv_color_make(0x00, 0xFF, 0x00);
//lv_color_t LV_COLOR_GREEN  = lv_color_make(0x00, 0x80, 0x00);
//lv_color_t LV_COLOR_CYAN   = lv_color_make(0x00, 0xFF, 0xFF);
//lv_color_t LV_COLOR_TEAL   = lv_color_make(0x00, 0x80, 0x80);
//lv_color_t LV_COLOR_BLUE   = lv_color_make(0x00, 0x00, 0xFF);
//lv_color_t LV_COLOR_NAVY   = lv_color_make(0x00, 0x00, 0x80);
//lv_color_t LV_COLOR_MAGENTA= lv_color_make(0xFF, 0x00, 0xFF);
//lv_color_t LV_COLOR_PURPLE = lv_color_make(0x80, 0x00, 0x80);
//lv_color_t LV_COLOR_ORANGE = lv_color_make(0xFF, 0xA5, 0x00);
/**********************
 *   GLOBAL FUNCTIONS
 **********************/
...
lv_color_t lv_palette_main(lv_palette_t p)
{
    static const lv_color_t colors[] = {
        ...
        LV_COLOR_MAKE(0x79, 0x55, 0x48), LV_COLOR_MAKE(0x60, 0x7D, 0x8B), LV_COLOR_MAKE(0x9E, 0x9E, 0x9E), LV_COLOR_MAKE(0xFF, 0xFF, 0xFF),
        };
