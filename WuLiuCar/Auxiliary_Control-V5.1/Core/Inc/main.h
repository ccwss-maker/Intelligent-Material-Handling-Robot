...
#define MASTER_SLAVE_I2C2_SCL_Pin GPIO_PIN_10
#define MASTER_SLAVE_I2C2_SCL_GPIO_Port GPIOB
#define MASTER_SLAVE_I2C2_SDA_Pin GPIO_PIN_11
#define MASTER_SLAVE_I2C2_SDA_GPIO_Port GPIOB
#define TRACKING_IMU_I2C1_SCL_Pin GPIO_PIN_9
#define TRACKING_IMU_I2C1_SCL_GPIO_Port GPIOA
#define TRACKING_IMU_I2C1_SDA_Pin GPIO_PIN_10
#define TRACKING_IMU_I2C1_SDA_GPIO_Port GPIOA
#define BLE_UART1_STATE_Pin GPIO_PIN_5
#define BLE_UART1_STATE_GPIO_Port GPIOB
