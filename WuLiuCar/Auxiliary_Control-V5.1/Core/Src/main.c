...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, ENCODER_SPI1_CS1_Pin|ENCODER_SPI1_CS2_Pin|ENCODER_SPI1_CS3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ENCODER_SPI1_CS1_Pin ENCODER_SPI1_CS2_Pin ENCODER_SPI1_CS3_Pin */
  ...
  /*Configure GPIO pin : BLE_UART1_STATE_Pin */
