...
static void slider_event_cb_FL(lv_event_t * e)
{
    char buf[20];
    int slider_value = (int)lv_slider_get_value(lv_obj_WHEEL.slider_FL.slider);
    lv_snprintf(buf, sizeof(buf), "%d", slider_value);
    lv_label_set_text(lv_obj_WHEEL.slider_FL.slider_label, buf);
    Motor_Speed_Control(1,slider_value,255);
}

static void slider_event_cb_FR(lv_event_t * e)
{
    char buf[20];
    int slider_value = (int)lv_slider_get_value(lv_obj_WHEEL.slider_FR.slider);
    lv_snprintf(buf, sizeof(buf), "%d", slider_value);
    lv_label_set_text(lv_obj_WHEEL.slider_FR.slider_label, buf);
    Motor_Speed_Control(2,slider_value,255);
}

static void slider_event_cb_BL(lv_event_t * e)
{
    char buf[20];
    int slider_value = (int)lv_slider_get_value(lv_obj_WHEEL.slider_BL.slider);
    lv_snprintf(buf, sizeof(buf), "%d", slider_value);
    lv_label_set_text(lv_obj_WHEEL.slider_BL.slider_label, buf);
    Motor_Speed_Control(3,slider_value,255);
}

static void slider_event_cb_BR(lv_event_t * e)
{
    char buf[20];
    int slider_value = (int)lv_slider_get_value(lv_obj_WHEEL.slider_BR.slider);
    lv_snprintf(buf, sizeof(buf), "%d", slider_value);
    lv_label_set_text(lv_obj_WHEEL.slider_BR.slider_label, buf);
    Motor_Speed_Control(4,slider_value,255);
}
...
{	
    ...
    lv_obj_WHEEL.sw_debug = lv_obj_get_child(cont, 1);
    lv_obj_set_width(lv_obj_WHEEL.sw_debug,70);
    lv_obj_add_event_cb(lv_obj_WHEEL.sw_debug, switch_event_cb_debug, LV_EVENT_VALUE_CHANGED, NULL);
    /*动力开关*/
    ...
    lv_obj_add_event_cb(lv_obj_WHEEL.slider_FL.slider, slider_event_cb_FL, LV_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_add_event_cb(lv_obj_WHEEL.slider_FR.slider, slider_event_cb_FR, LV_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_add_event_cb(lv_obj_WHEEL.slider_BL.slider, slider_event_cb_BL, LV_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_add_event_cb(lv_obj_WHEEL.slider_BR.slider, slider_event_cb_BR, LV_EVENT_VALUE_CHANGED, NULL);
