...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(DingTalk_JinBuTi_English_14) LV_FONT_DECLARE(DingTalk_JinBuTi_Chinese_16)

/*Always set a default font*/
#define LV_FONT_DEFAULT &DingTalk_JinBuTi_English_14
