...
#define TOUCH_RST_H HAL_GPIO_WritePin(TOUCH_RST_GPIO_Port,TOUCH_RST_Pin,GPIO_PIN_SET)
#define TOUCH_RST_L HAL_GPIO_WritePin(TOUCH_RST_GPIO_Port,TOUCH_RST_Pin,GPIO_PIN_RESET)

#define TOUCH_INT_H HAL_GPIO_WritePin(TOUCH_INT_GPIO_Port,TOUCH_INT_Pin,GPIO_PIN_SET)
#define TOUCH_INT_L HAL_GPIO_WritePin(TOUCH_INT_GPIO_Port,TOUCH_INT_Pin,GPIO_PIN_RESET)
